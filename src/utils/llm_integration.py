...
class LLMIntegration:
    ...
    def generate_text(self, prompt: str, model: Optional[str] = None, 
        ...
        try:
            ...
            # 根据提供商调用不同的API
            if provider == 'openai':
                return self._generate_openai(prompt, model_name, system_prompt, temperature, max_tokens)
            elif provider == 'anthropic':
                return self._generate_anthropic(prompt, model_name, system_prompt, temperature, max_tokens)
            elif provider == 'deepseek':
                return self._generate_deepseek(prompt, model_name, system_prompt, temperature, max_tokens)
            else:
    ...
    def analyze_code(self, code: str, query: str, model: Optional[str] = None) -> Dict[str, Any]:
        """
        分析代码并回答相关问题
        ...
        return self.generate_text(
            ...
            temperature=0.3,  # 代码分析使用较低温度以获取更准确的结果
            max_tokens=1500
        )
    
    def generate_tool_description(self, tool_function, model: Optional[str] = None) -> Dict[str, Any]:
        """
        为工具函数生成详细的描述和文档
        ...
        system_prompt = "你是一位专业的API文档生成专家，为给定的函数生成清晰、准确的描述和文档。"
    ...
    def _generate_deepseek(self, prompt: str, model: str, 
                          system_prompt: Optional[str], 
                          temperature: float, 
                          max_tokens: int) -> Dict[str, Any]:
        """
